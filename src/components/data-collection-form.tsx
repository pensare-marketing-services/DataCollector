...
export type UserData = Omit<FormValues, 'photo' | 'acceptedDeclaration'> & { memberId: string; photoURL: string; id?: string; submissionDate: string; };
